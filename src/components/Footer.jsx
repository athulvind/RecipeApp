...
const Footer = () => {
  return (
    <div style={{ height: '300px',width:'100%',backgroundColor:'rgba(146, 27, 27, 0.41)' }} className=' mt-5 bg-slate-300 shadow p-5'>
      <div className='d-flex justify-content-around '>
        ...
        <div className='d-flex flex-column justify-content-between '>
          ...
          <div className='icons d-flex justify-content-between mb-5'>
